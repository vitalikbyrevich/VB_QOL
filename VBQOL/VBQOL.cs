...
namespace VBQOL
{
    ...
    class VBQOL : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            VB_BuildDamage.enableModBDConfig = Config.BindConfig("03 - BuildDamage", "BD_Enable_Section", true, "Включите или отключите этот раздел", synced: true); 
            VB_BuildDamage.creatorDamageMultConfig = Config.BindConfig("03 - BuildDamage", "BD_CreatorDamageMult", 0.75f, "Множитель урона от создателя постройки", synced: true);
            VB_BuildDamage.nonCreatorDamageMultConfig = Config.BindConfig("03 - BuildDamage", "BD_NonCreatorDamageMult", 0.05f, "Множитель урона от не создателя постройки", synced: true);
            VB_BuildDamage.uncreatedDamageMultConfig = Config.BindConfig("03 - BuildDamage", "BD_UncreatedDamageMult", 0.75f, "Множитель урона постройкам не созданным игроком", synced: true);
            VB_BuildDamage.naturalDamageMultConfig = Config.BindConfig("03 - BuildDamage", "BD_NaturalDamageMult", 0.75f, "Множитель урона от погоды и монстров.",synced: true);

            VB_EquipInWater.EiW_Custom = Config.BindConfig("04 - EquipInWater", "EiW_Custom",
